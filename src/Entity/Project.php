...
class Project
{
    ...
    #[ORM\Column(type: 'string', length: 20, nullable: false, options: ['default' => self::STATUS_PENDING])]
    private string $stateProj = self::STATUS_PENDING;

    #[ORM\Column(type: 'datetime', nullable: false, options: ['default' => 'CURRENT_TIMESTAMP'])]
    private \DateTimeInterface $createdAtProj;

    #[ORM\Column(type: 'datetime', nullable: false, options: ['default' => 'CURRENT_TIMESTAMP'])]
    private \DateTimeInterface $updatedAtProj;
    ...
    {
        if ($this->investments->removeElement($investment) && $investment->getProject() === $this) {
    ...
    {
        if ($this->strategies->removeElement($strategie) && $strategie->getProject() === $this) {
            $strategie->setProject(null);
        }
