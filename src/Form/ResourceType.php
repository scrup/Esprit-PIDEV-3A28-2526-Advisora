...
/**
 * @extends AbstractType<Resource>
 */
class ResourceType extends AbstractType
{
    /**
     * @param FormBuilderInterface<Resource|null> $builder
        ...
        $builder
            ...
            ->add('cataloguefournisseur', EntityType::class, [
                ...
                'choice_label' => static function (Cataloguefournisseur $supplier): string {
                    ...
                    if (
                        $supplier->getFournisseur()
                        && $supplier->getNomFr()
                        && $supplier->getFournisseur() !== $supplier->getNomFr()
                    ) {
            ...
            ->add('prixRs', NumberType::class, [
                ...
                'constraints' => [
                    ...
                    new GreaterThanOrEqual([
                        'value' => 0,
                        'message' => 'Le prix unitaire doit etre superieur ou egal a 0.',
                    ]),
                ],
            ])
