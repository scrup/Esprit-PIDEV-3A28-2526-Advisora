...
class InvestmentType extends AbstractType
{
    ...
    {
        if ($options['include_project'] === true) {
        ...
        $builder
            ...
            ->add('bud_minInv', NumberType::class, [
                ...
                'constraints' => [
                    ...
                    new GreaterThan([
                        'value' => 0,
                        'message' => 'Le montant minimum doit etre strictement superieur a 0.',
                    ]),
                ],
            ])
            ->add('bud_maxInv', NumberType::class, [
                ...
                'constraints' => [
                    ...
                    new GreaterThanOrEqual([
                        'value' => 0.01,
                        'message' => 'Le montant maximum doit etre superieur ou egal a 0.01.',
                    ]),
                ],
            ])
