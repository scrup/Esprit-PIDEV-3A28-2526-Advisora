...
final class GeminiTopProjectsService
{
    ...
    /**
     * Simple aliases to display a relevant flag for common countries.
     *
    ...
    private const COUNTRY_FLAGS = [
        ...
        'egypte' => 'ðŸ‡ªðŸ‡¬',
        'egypt' => 'ðŸ‡ªðŸ‡¬',
        'emirats arabes unis' => 'ðŸ‡¦ðŸ‡ª',
        'emirates arabes unis' => 'ðŸ‡¦ðŸ‡ª',
        'espagne' => 'ðŸ‡ªðŸ‡¸',
        'france' => 'ðŸ‡«ðŸ‡·',
        'germany' => 'ðŸ‡©ðŸ‡ª',
        'inde' => 'ðŸ‡®ðŸ‡³',
    ...
    {
        return match ($rank) {
            1 => ['medal' => 'ðŸ¥‡', 'border_class' => 'top10-rank-gold', 'progress' => 100],
            2 => ['medal' => 'ðŸ¥ˆ', 'border_class' => 'top10-rank-silver', 'progress' => 92],
            3 => ['medal' => 'ðŸ¥‰', 'border_class' => 'top10-rank-bronze', 'progress' => 84],
            default => [
                'medal' => '',
    ...
    private function normalizeLookupKey(string $value): string
    {
        ...
        $value = str_replace(
            ['Ã ', 'Ã¡', 'Ã¢', 'Ã¤', 'Ã£', 'Ã¥', 'Ã§', 'Ã¨', 'Ã©', 'Ãª', 'Ã«', 'Ã¬', 'Ã­', 'Ã®', 'Ã¯', 'Ã±', 'Ã²', 'Ã³', 'Ã´', 'Ã¶', 'Ãµ', 'Ã¹', 'Ãº', 'Ã»', 'Ã¼', 'Ã½', 'Ã¿', "'", 'â€™'],
